...
. Proteggi l'amministrazione con la verifica multi-amministratore (MAV) in aggiunta all'autenticazione a più fattori (MFA), migliorando la sicurezza per l'accesso amministrativo alla VM di archiviazione dati.
