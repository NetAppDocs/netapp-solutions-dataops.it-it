...
summary: Questa soluzione si basa su un cliente che ha bisogno di copiare dati in base a una data specifica. 
---
= Scansione e copia dei dati basata su date specifiche
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Questa soluzione si basa su un cliente che ha bisogno di copiare dati in base a una data specifica.  Verificare i seguenti dettagli:
